...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const sidebarNavigation = [
    { name: 'Mi Semana', href: '/mi-semana', icon: LayoutDashboard },
    { name: 'Contenido', href: '/contenido', icon: Calendar },
    { name: 'Proyectos', href: '/projects', icon: FolderKanban },
    { name: 'Clientes', href: '/clients', icon: Users },
    { name: 'Analytics', href: '/analytics', icon: BarChart3, adminOnly: true },
    { name: 'Crew', href: '/admin/crew', icon: UserCog, adminOnly: true },
    { name: 'Accesos', href: '/admin/clientes', icon: Shield, adminOnly: true },
  ]
